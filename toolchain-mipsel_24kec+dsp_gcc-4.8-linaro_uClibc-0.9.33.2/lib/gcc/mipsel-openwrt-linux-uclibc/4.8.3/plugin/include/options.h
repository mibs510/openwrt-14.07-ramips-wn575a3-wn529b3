...
enum opt_code
{
  ...
  OPT_mmt = 1098,                            /* -mmt */
  OPT_mmusl = 1099,                          /* -mmusl */
  OPT_mno_float = 1100,                      /* -mno-float */
  OPT_mno_flush_func = 1101,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1102,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1103,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1104,                     /* -mno-mips3d */
  OPT_mpaired_single = 1105,                 /* -mpaired-single */
  OPT_mplt = 1106,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1107,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1108,               /* -mrelax-pic-calls */
  OPT_mshared = 1109,                        /* -mshared */
  OPT_msingle_float = 1110,                  /* -msingle-float */
  OPT_msmartmips = 1111,                     /* -msmartmips */
  OPT_msoft_float = 1112,                    /* -msoft-float */
  OPT_msplit_addresses = 1113,               /* -msplit-addresses */
  OPT_msym32 = 1114,                         /* -msym32 */
  OPT_msynci = 1115,                         /* -msynci */
  OPT_mtune_ = 1116,                         /* -mtune= */
  OPT_muclibc = 1117,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1118,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1119,                  /* -mvr4130-align */
  OPT_mxgot = 1120,                          /* -mxgot */
  OPT_n = 1121,                              /* -n */
  OPT_no_canonical_prefixes = 1122,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1123,              /* -no-integrated-cpp */
  OPT_noasmopt = 1124,                       /* -noasmopt */
  OPT_nocpp = 1125,                          /* -nocpp */
  OPT_nodefaultlibs = 1126,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1127,                   /* -nostartfiles */
  OPT_nostdinc = 1128,                       /* -nostdinc */
  OPT_nostdinc__ = 1129,                     /* -nostdinc++ */
  OPT_nostdlib = 1130,                       /* -nostdlib */
  OPT_o = 1131,                              /* -o */
  OPT_p = 1132,                              /* -p */
  OPT_pass_exit_codes = 1133,                /* -pass-exit-codes */
  /* OPT_pedantic = 1134, */                 /* -pedantic */
  OPT_pedantic_errors = 1135,                /* -pedantic-errors */
  OPT_pg = 1136,                             /* -pg */
  OPT_pie = 1137,                            /* -pie */
  OPT_pipe = 1138,                           /* -pipe */
  OPT_posix = 1139,                          /* -posix */
  OPT_print_file_name_ = 1140,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1141,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1142,          /* -print-multi-directory */
  OPT_print_multi_lib = 1143,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1144,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1145,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1146,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1147,               /* -print-prog-name= */
  OPT_print_search_dirs = 1148,              /* -print-search-dirs */
  OPT_print_sysroot = 1149,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1150,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1151,                        /* -profile */
  OPT_pthread = 1152,                        /* -pthread */
  OPT_quiet = 1153,                          /* -quiet */
  OPT_r = 1154,                              /* -r */
  OPT_rdynamic = 1155,                       /* -rdynamic */
  OPT_remap = 1156,                          /* -remap */
  OPT_s = 1157,                              /* -s */
  OPT_s_bc_abi = 1158,                       /* -s-bc-abi */
  OPT_save_temps = 1159,                     /* -save-temps */
  OPT_save_temps_ = 1160,                    /* -save-temps= */
  OPT_shared = 1161,                         /* -shared */
  OPT_shared_libgcc = 1162,                  /* -shared-libgcc */
  /* OPT_specs = 1163, */                    /* -specs */
  OPT_specs_ = 1164,                         /* -specs= */
  OPT_static = 1165,                         /* -static */
  OPT_static_libasan = 1166,                 /* -static-libasan */
  OPT_static_libgcc = 1167,                  /* -static-libgcc */
  OPT_static_libgcj = 1168,                  /* -static-libgcj */
  OPT_static_libgfortran = 1169,             /* -static-libgfortran */
  OPT_static_libgo = 1170,                   /* -static-libgo */
  OPT_static_libstdc__ = 1171,               /* -static-libstdc++ */
  OPT_static_libtsan = 1172,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1173, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1174, */                /* -std=c++0x */
  OPT_std_c__11 = 1175,                      /* -std=c++11 */
  OPT_std_c__1y = 1176,                      /* -std=c++1y */
  OPT_std_c__98 = 1177,                      /* -std=c++98 */
  OPT_std_c11 = 1178,                        /* -std=c11 */
  /* OPT_std_c1x = 1179, */                  /* -std=c1x */
  /* OPT_std_c89 = 1180, */                  /* -std=c89 */
  OPT_std_c90 = 1181,                        /* -std=c90 */
  OPT_std_c99 = 1182,                        /* -std=c99 */
  /* OPT_std_c9x = 1183, */                  /* -std=c9x */
  OPT_std_f2003 = 1184,                      /* -std=f2003 */
  OPT_std_f2008 = 1185,                      /* -std=f2008 */
  OPT_std_f2008ts = 1186,                    /* -std=f2008ts */
  OPT_std_f95 = 1187,                        /* -std=f95 */
  OPT_std_gnu = 1188,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1189, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1190, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1191,                    /* -std=gnu++11 */
